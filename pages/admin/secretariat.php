    ...
    <div class="panel panel-success">
      ...
      <div class="panel-body">
        ...
        foreach($res as $val){
            ...
            echo "
            <td><a class='btn btn-success' href='modifsecretaire.php?id=".$val['id_secretaire']."'><em class=\"far fa-edit\"></em></a> 
                <a class='btn btn-danger'  href='supsecretaire.php?id=".$val['id_secretaire']."' onclick=\"return confirm('êtes vous sure de vouloir supprimer cet enrégistrement ?')\";><em class=\"fas fa-trash-alt\"></em></a>
            </td>";
        }
          echo "</tbody>";
          echo "</table>";
